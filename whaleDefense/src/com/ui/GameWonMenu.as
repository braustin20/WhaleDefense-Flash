...
{	
	...
	public class GameWonMenu extends Sprite
	{
		...
		public function GameWonMenu(game:Game)
		{
			super();
			...
			var resumeTexture:Texture = game.assets.getTexture("nextLevel");
			var resumeImage:Image = new Image(resumeTexture);
			
			var resumeButton:MenuButton = new MenuButton(mainGame.stageWidth/2, 200, "Next Level", resumeImage);
